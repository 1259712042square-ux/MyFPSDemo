...
public:
	...
	/** Max tool-call loop iterations per request (0 = use safe default) */
	UPROPERTY(config, EditAnywhere, Category = "Execution", meta = (DisplayName = "Max Tool-Call Iterations (0 = Safe Default)", ClampMin = "0", ClampMax = "5000"))
